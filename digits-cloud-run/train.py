...
def main(
    ...
    checkpoint = ModelCheckpoint(
        os.path.join(output_path, filename + ".e{epoch:02d}-{accuracy:.2f}.hdf5")
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-d", "--data", help="directory to training and test data", default="data"
    )
    ...
    parser.add_argument(
        "-l", "--layer", help="number nodes in internal layer", default=128, type=int
    )
